...
def write_b2b_invoices(
    ...
    if "b2b" in sales_data:
        ...
        invoice_list = generate_invoices_list(
            ...
            invoice_term="inv",
            gen_json=gen_json,
            file_name=destination + "/" + file_name + "_GSTR1_b2b_sales.json",
        )
...
def write_b2b_credit_note_invoices(
    ...
    if "cdnr" in sales_data:
        ...
        invoice_list = generate_invoices_list(
            ...
            invoice_term="nt",
            gen_json=gen_json,
            file_name=destination + "/" + file_name + "_GSTR1_b2b_sales_returns.json",
        )
...
def write_b2cs_invoices(
    ...
    if "b2cs" in sales_data:
        ...
        invoice_list = generate_invoices_list(
            ...
            invoice_term="inv",
            gen_json=gen_json,
            file_name=destination + "/" + file_name + "_GSTR1_b2cs_sales.json",
        )
...
def write_export_invoices(
    ...
    if "exp" in sales_data:
        ...
        invoice_list = generate_invoices_list(
            ...
            invoice_term="inv",
            gen_json=gen_json,
            file_name=destination + "/" + file_name + "_GSTR1_export_sales.json",
        )
...
def write_b2ba_invoices(
    ...
    if "b2ba" in sales_data:
        ...
        invoice_list = generate_invoices_list(
            ...
            invoice_term="inv",
            gen_json=gen_json,
            file_name=destination + "/" + file_name + "_GSTR1_b2ba_sales.json",
        )
